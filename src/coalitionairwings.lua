...
US.AirWings.USAW380:SetRespawnAfterDestroyed(60*60*24*5)
US.AirWings.USAW380:SetTakeoffCold()
US.AirWings.USAW380:__Start(2)
...
US.AirWings.USCAW9:SetRespawnAfterDestroyed(60*60*24*5)
US.AirWings.USCAW9:SetTakeoffCold()
...
US.Squadrons.USVFA14 = SQUADRON:New("TopHatters",12,"Tophatters") -- F14A135GR
...
US.Squadrons.USVFA14:SetTakeoffCold()
...
US.Squadrons.USVFA192 = SQUADRON:New("Dragons",12,"Dragons") -- F18C
...
US.Squadrons.USVFA192:SetTakeoffCold()
...
US.Squadrons.USVMFA314 = SQUADRON:New("BlackKnights",12,"Black Knights")
...
US.Squadrons.USVMFA314:SetTakeoffCold()
...
US.Squadrons.USVFA151 = SQUADRON:New("Vigilantes", 12,"Vigilantes")
...
US.Squadrons.US12SQNESC = SQUADRON:New("F15Escort",12,"525th Fighter Squadron - Escort")
...
US.Squadrons.US12THAID = SQUADRON:New("F15Cap",12,"525th Fighter Squadron - Air Interdiction")
