...
WESTAWACS:SetAICAPDetails(CALLSIGN.Aircraft.Ford,3,4,RGUTILS.CalculateTAS(22000,350,0))
...
CARRIERAWACS:SetAICAPDetails("Hornet",2,2,RGUTILS.CalculateTAS(22000,350,0))
